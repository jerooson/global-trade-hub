...
const Login = () => {
  ...
  const handleWeChatLogin = () => {
    // TODO: Enable when WeChat OAuth is configured
    alert("WeChat login coming soon!");
  };
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold">Welcome to TradeHub</CardTitle>
          <CardDescription>
            Sign in to access your global trade management platform
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            {(error || oauthError) && (
              <Alert variant="destructive">
                ...
                <AlertDescription>
                  {oauthError === "auth_failed" ? "Authentication failed. Please try again." : error}
                </AlertDescription>
              </Alert>
            )}
